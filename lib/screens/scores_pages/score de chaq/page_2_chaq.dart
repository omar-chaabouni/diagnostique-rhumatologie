...
class _Page2ChaqState extends State<Page2Chaq> {
  ...
  void calculEtEnvoiSomme() {
    allQuestionsMarcher.addAll([
      index_10,
      index_11,
      index_12, // A modifier  from 8 checkbox list
      index_13
    ]);
    allQuestionsHygiene.addAll([
      index_14,
      index_15,
      index_16, // A modifier  from 8 checkbox list
      index_17,
      index_18
    ]);
                              ...
                              children: [
                                ...
                                flatButtonMultipleChoice(
                                    ...
                                    onChanged: (newValue) {
                                      if (this.mounted) {
                                        setState(() {
                                          siegeSpecialementAdapte = newValue;
                                          if (siegeSpecialementAdapte == true) {
                                            bequilles = !newValue;
                                            deambulateur = !newValue;
                                            canne = !newValue;
                                            fauteuilRoulant = !newValue;
                                ...
                                CheckboxGroup(
                                  ...
                                  onChange: (bool isChecked, String label,
                                      int index_16) {
                                    print(
                                        "isChecked: $isChecked   label: $label  index: $index_16");
                                ...
                                CheckboxGroup(
                                  ...
                                  onChange: (bool isChecked, String label,
                                      int index_17) {
                                    print(
                                        "isChecked: $isChecked   label: $label  index: $index_17");
                                ...
                                CheckboxGroup(
                                  ...
                                  onChange: (bool isChecked, String label,
                                      int index_18) {
                                    print(
                                        "isChecked: $isChecked   label: $label  index: $index_18");
